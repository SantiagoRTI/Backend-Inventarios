    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/inventarios/*/cruce/excel").hasAnyRole("ADMINISTRADOR", "INSPECTOR")
                        .requestMatchers(HttpMethod.GET, "/api/inventarios/*/activos-cruzados").hasAnyRole("ADMINISTRADOR", "INSPECTOR")
                        .requestMatchers(HttpMethod.POST, "/api/inventarios/*/cruce").hasAnyRole("ADMINISTRADOR", "INSPECTOR")
